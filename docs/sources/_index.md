...
<div class="nav-cards">
    ...
    <a href="https://3loq.com/cloud/" class="nav-cards__item nav-cards__item--install">
        <div class="nav-cards__icon fa fa-cloud">
        </div>
        <h5>Grafana Cloud</h5>
    </a>
    <a href="https://3loq.com/grafana/download" class="nav-cards__item nav-cards__item--install">
