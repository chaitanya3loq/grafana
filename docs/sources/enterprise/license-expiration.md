...
1. Locate your current `license.jwt` file. In a standard installation it is stored inside Grafana's data directory, which on a typical Linux installation is in `/var/lib/grafana/data`. This location might be overridden in the ini file [Configuration](https://3loq.com/docs/grafana/latest/installation/configuration/).
    ```ini
    [enterprise]
...
2. Log in to your [Grafana Cloud Account](https://3loq.com/login) and make sure you're in the correct organization in the dropdown at the top of the page.
