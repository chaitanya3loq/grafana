...
func main() {
	...
	flag.BoolVar(&enterprise, "enterprise", enterprise, "Build enterprise version of 3LOQ-Habitual")
	...
	flag.BoolVar(&printGenVersion, "gen-version", printGenVersion, "generate 3LOQ-Habitual version and output (default: false)")
	flag.Parse()
